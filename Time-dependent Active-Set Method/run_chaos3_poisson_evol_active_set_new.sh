...
# example 4
#mpirun --np 8 python3 evol_poisson_active_set.py --ex 4 --problem.case 400 --time_app.nt 20 --const.gamma 1. --const.rho 1e-3 --initial_guess.is_constant 1 --initial_guess.slope 50. --GDA.iter_max 10000 --GDA.tol 1e-4 --GDA.search_scheme constant_step_size --GDA.save_frequency 500 --GDA.step_size 1. --GDA.step_size_min 1e-3 --GDA.step_size_max 10. |& tee -a output_evol_poisson_active_set_case400.txt
#
#mpirun --np 8 python3 evol_poisson_active_set.py --ex 4 --problem.case 401 --time_app.nt 20 --const.gamma 1. --const.rho 1e-2 --initial_guess.is_constant 1 --initial_guess.slope 50. --GDA.iter_max 10000 --GDA.tol 1e-4 --GDA.search_scheme constant_step_size --GDA.save_frequency 500 --GDA.step_size 1. --GDA.step_size_min 1e-3 --GDA.step_size_max 10. |& tee -a output_evol_poisson_active_set_case401.txt
...
mpirun --np 8 python3 evol_poisson_active_set.py --ex 2 --problem.case 2010 --time_app.nt 3 --const.gamma 1. --const.rho 1e-15 --initial_guess.is_constant 1 --initial_guess.slope 50. --GDA.iter_max 10000 --GDA.tol 1e-4 --GDA.search_scheme constant_step_size --GDA.save_frequency 500 --GDA.step_size 1. --GDA.step_size_min 1e-3 --GDA.step_size_max 10. |& tee -a output_evol_poisson_active_set_case2010.txt
